# coding=utf-8
# --------------------------------
YOUR_Email_For_TAkeAdmin_Exploit = 'izazelus3@gmail.com'  # Edit this line with your email Address
r = '\033[31m'
g = '\033[32m'  # KingBoT Version 1.0 [31/12/2019]
y = '\033[33m'  # Not! : illegal kullanimda herhangi bir sorumluluk kabul etmiyoruz.
b = '\033[34m'  # Bu araç guvenlik aciklarini taramak icindir.
m = '\033[35m'  
c = '\033[36m' 
w = '\033[37m'  
# --------------------------------
